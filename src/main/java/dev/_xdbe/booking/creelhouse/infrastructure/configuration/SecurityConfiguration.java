...
public class SecurityConfiguration {
    ...
    public UserDetailsService userDetailsService() {
        UserDetails administrator = User.builder()
            .username("admin")
            .password("{bcrypt}$2a$10$g0CayepbF7qzt.Caw5Jwzu6YIpScFrCytRgQIgyW6bgSyt2JZX4te")
            .roles("ADMIN")
            .build();

        UserDetails guest = User.builder()
            .username("guest")
            .password("{bcrypt}$2a$10$kdCjArfO75te9ergv6HJSul3C.WIT/GrrsZ6FAVuTpk2WQOOtQuEa")
            .roles("GUEST")
            .build();
